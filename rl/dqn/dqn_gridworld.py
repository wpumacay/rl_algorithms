...
AGENT_CONFIG.epsilonDecay               = 0.9995
AGENT_CONFIG.lr                         = 0.01
AGENT_CONFIG.minibatchSize              = 1
AGENT_CONFIG.learningStartsAt           = 0
AGENT_CONFIG.learningUpdateFreq         = 1
AGENT_CONFIG.learningUpdateTargetFreq   = 1
AGENT_CONFIG.learningMaxSteps           = 100000
AGENT_CONFIG.replayBufferSize           = 1
AGENT_CONFIG.discount                   = 0.99
AGENT_CONFIG.tau                        = 1.0
AGENT_CONFIG.seed                       = 0
